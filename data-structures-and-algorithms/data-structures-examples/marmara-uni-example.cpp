...
stack * sayilariTopla(stack * result1,stack * result2){ // -> res1 -> 4 hane / res2 -> 4+1 hane (res2 daha buyuk olarak yazilmis fonk)
	...
	// result1 = 415 , result2 = 8910 , sayilarintoplami = 9325
	// 8910
	//  415
...
int main(){
	...
	stack * sayi1 = NULL; // 415
	stack * sayi2 = NULL; // 8910
	stack * result = NULL; // 9325
	...
	result = sayilariTopla(sayi1,sayi2);
	bas(result);
